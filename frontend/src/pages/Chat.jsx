...
const Chat = ({ chatId, user }) => {
  ...
  const messageOnChange = (e) => {
    ...
    if (!IamTyping) {
      console.log("Emitting START_TYPING event"); // Log for START_TYPING
    ...
    typingTimeout.current = setTimeout(() => {
      console.log("Emitting STOP_TYPING event"); // Log for STOP_TYPING
  ...
  const startTypingListener = useCallback(
    (data) => {
      if (data.chatId !== chatId) return;
      console.log("Received START_TYPING event"); // Log for receiving START_TYPING
      setUserTyping(true);
    },
    [chatId]
  );
  ...
  const stopTypingListener = useCallback(
    (data) => {
      if (data.chatId !== chatId) return;
      console.log("Received STOP_TYPING event"); // Log for receiving STOP_TYPING
      setUserTyping(false);
    },
    [chatId]
  );
